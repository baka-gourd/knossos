...
<div class="hero">
	...
	<h1 class="hero__tagline">{$t('index.hero_tagline')}</h1>
	...
	<p class="hero__description">{$t('index.hero_description')}</p>
</div>
...
<div class="features">
	<div class="features__item">
		...
		<div class="features__item__text">
			<h3 class="title-secondary">{$t('index.feature.api')}</h3>
			<p class="summary">{$t('index.feature.api_description')}</p>
		</div>
	</div>
	<div class="features__item">
		<img src={ImageDollar} alt="Gold coin" class="features__item__image" />
		<div class="features__item__text">
			<h3 class="title-secondary">{$t('index.feature.earn')}</h3>
			<p class="summary">{$t('index.feature.earn_description')}</p>
		</div>
	</div>
	<div class="features__item">
		<img src={ImageExplorer} alt="Speedometer" class="features__item__image" />
		<div class="features__item__text">
			<h3 class="title-secondary">{$t('index.feature.lighting')}</h3>
			<p class="summary">{$t('index.feature.lighting_description')}</p>
		</div>
	</div>
	<div class="features__item">
		<img src={ImageChatBubble} alt="Two chat bubbles" class="features__item__image" />
		<div class="features__item__text">
			<h3 class="title-secondary">{$t('index.feature.helpful')}</h3>
			<p class="summary">{$t('index.feature.helpful_description')}</p>
		</div>
	</div>
	<div class="features__item">
		<img src={ImagePuzzle} alt="Puzzle piece" class="features__item__image" />
		<div class="features__item__text">
			<h3 class="title-secondary">{$t('index.feature.extensible')}</h3>
			<p class="summary">{$t('index.feature.extensible_description')}</p>
		</div>
	</div>
	<div class="features__item">
		<img src={ImageTool} alt="Screwdriver and wrench" class="features__item__image" />
		<div class="features__item__text">
			<h3 class="title-secondary">{$t('index.feature.oss')}</h3>
			<p class="summary">{$t('index.feature.oss_description')}</p>
		</div>
	</div>
</div>
